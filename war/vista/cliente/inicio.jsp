...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
      <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2"><a href="quienessomos.html"><img class="img-circle" alt="Free Shipping" src="img/quienessomos.jpg"></a></div>
        <div class="col-lg-6 col-md-9 col-xs-9 col-sm-7">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
     <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2"><a href="#"><img class="img-circle" alt="Free Shipping" src="img/registrarse.jpg"></a></div>
        <div class="col-lg-6 col-md-9 col-xs-9 col-sm-7">
          <h4><center>cuenta</center></h4>
        </div>      
      </div> 
    </div>       
  </div>
...
<div class="container">
  ...
  <nav class="text-center">
    ...
    <ul class="pagination">
      ...
      <li class="active"><a href="inicio.jsp">1</a></li>
