  ...
  <div class="container">     
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        <li class="active"><a href="../../iniciovendedor.jsp">Inicio <span class="sr-only">(current)</span></a> </li>
     
        <li class="dropdown"> <a href="../../iniciovendedor.jsp" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Menu <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="#"></a> </li>
            <li><a href="iniciovendedor.jsp">Principal</a> </li>
            <li class="divider"></li>
            ...
            <% %>
            <a href="../../listavendedor">lista</a> </li><% %>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
      <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2"><a href="#"><img class="img-circle" alt="Free Shipping" src="img/quienessomos.jpg"></a></div>
        <div class="col-lg-6 col-md-9 col-xs-9 col-sm-7">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
     <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-2"><a href="../../listavendedor"><img class="img-circle" alt="Free Shipping" src="img/registrarse.jpg"></a></div>
        <div class="col-lg-6 col-md-9 col-xs-9 col-sm-7">
          <h4><center>lista usuarios</center></h4>
        </div>      
      </div> 
    </div>       
  </div>
